...
(function() {
  var HttpPromise, Request, RequestFormat, exports;
  ...
  HttpPromise = (function() {
    HttpPromise.format = function(name) {
      return RequestFormat[name];
    };

    HttpPromise.setFormat = function(name, options) {
      return RequestFormat[name] = options;
    };
    ...
    function HttpPromise(config) {
      ...
      this.config = config;
      (base = this.config).type || (base.type = 'json');
    }

    HttpPromise.prototype.get = function(url, params) {
      var k, q, qs, v;
      if (params) {
        q = [];
        for (k in params) {
    ...
    HttpPromise.prototype.post = function(url, data) {
      return this.request('post', url, data);
    };

    HttpPromise.prototype.put = function(url, data) {
      return this.request('put', url, data);
    };

    HttpPromise.prototype.patch = function(url, data) {
      return this.request('patch', url, data);
    };

    HttpPromise.prototype["delete"] = function(url, data) {
      return this.request('delete', url, data);
    };

    HttpPromise.prototype.request = function(method, url, data) {
      return new Request(this.config, method, url, data);
    };
